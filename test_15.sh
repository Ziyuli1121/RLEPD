# peak memory: 30989 MiB

# python -m training.ppo.export_epd_predictor \
#   exps/20251222-171726-sd15_k20 \
...
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step001000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_1000

# MASTER_PORT=22222 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step002000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_2000

# MASTER_PORT=33333 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step003000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_3000

# MASTER_PORT=44444 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step004000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_4000

# MASTER_PORT=55555 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step005000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_5000

# MASTER_PORT=11111 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step006000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_6000

# MASTER_PORT=22222 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step007000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_7000

# MASTER_PORT=33333 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step008000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_8000

# MASTER_PORT=44444 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step009000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_9000

# MASTER_PORT=55555 python sample.py \
#   --predictor_path exps/20251222-171726-sd15_k20/export/network-snapshot-export-step010000.pkl \
#   --prompt-file src/prompts/test.txt \
#   --seeds "0-999" \
#   --batch 16 \
#   --outdir ./samples/15_10000
...
score_all_metrics 15_1000
score_all_metrics 15_2000
score_all_metrics 15_3000
score_all_metrics 15_4000
score_all_metrics 15_5000
score_all_metrics 15_6000
score_all_metrics 15_7000
score_all_metrics 15_8000
score_all_metrics 15_9000
# score_all_metrics 15_10000